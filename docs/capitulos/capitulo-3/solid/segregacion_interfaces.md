...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/segregacion_interfaces/isp_analogia_caso1.png"
...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/segregacion_interfaces/isp_analogia_caso2.png"
       width="85%" height="auto"
...
<table style="width:100%; border-collapse:collapse;">
  ...
  <tbody>
    <tr>
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../segregacion_interfaces-ejemplo1_figuras_geometricas/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
    <tr>
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../segregacion_interfaces-ejemplo2_gestion_iot/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
  </tbody>
</table>
...
| --- | --- |
| **Problema que aborda** | Una interfaz obliga a implementar métodos que algunos clientes no necesitan. |
| **Escenario de aplicación** | Dispositivos IoT o figuras con capacidades dimensionales distintas. |
| **Ventaja principal** | Cada cliente depende únicamente de las operaciones que utiliza. |
| **Desventaja o precaución** | Demasiadas interfaces mínimas pueden dispersar un contrato conceptualmente indivisible. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo3/solid/segregacion_interfaces/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
