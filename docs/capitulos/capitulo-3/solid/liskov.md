...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/liskov/lsp_analogia_caso1.png"
...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/liskov/lsp_analogia_caso2.png"
       width="85%" height="auto"
...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/liskov/lsp_analogia_caso3.png"
       width="85%" height="auto"
...
<table style="width:100%; border-collapse:collapse;">
  ...
  <tbody>
    <tr>
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../liskov-ejemplo1_figuras_geometrica/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
    <tr>
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../liskov-ejemplo2_estacion_servicio/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
  </tbody>
</table>
...
| --- | --- |
| **Problema que aborda** | Un subtipo rechaza operaciones, cambia resultados o rompe invariantes del tipo base. |
| **Escenario de aplicación** | Jerarquías de figuras, vehículos, medios de pago o dispositivos. |
| **Ventaja principal** | Los clientes pueden trabajar con el contrato sin comprobar tipos concretos. |
| **Desventaja o precaución** | Una jerarquía demasiado amplia oculta capacidades diferentes y produce sustituciones falsas. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo3/solid/liskov/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
