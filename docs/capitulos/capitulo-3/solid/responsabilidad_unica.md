...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/responsabilidad_unica/srp_analogia_caso1.png" width="90%" height="auto" alt="Caso 1: José asume múltiples responsabilidades"/>
</p>
...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/responsabilidad_unica/srp_analogia_caso2.png" width="90%" height="auto" alt="Caso 2: entorno con baja cohesión"/>
</p>
...
<p style="text-align:center;">
  <img src="../../../../assets/images/contenido/capitulos/capitulo3/solid/responsabilidad_unica/srp_analogia_caso3.png" width="90%" height="auto" alt="Caso 3: entorno que cumple el SRP"/>
</p>
  ...
  <tbody>
    <tr>
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../responsabilidad_unica-ejemplo1_figuras_geometricas/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
    <tr>
      ...
      <td style="border:1px solid #ddd; padding:8px; text-align:center;">
         <a href="../responsabilidad_unica-ejemplo2_manipulacion_facturas/" target="_blank"><b>Ir al ejemplo</b></a>
      </td>
    </tr>
  </tbody>
</table>
...
| --- | --- |
| **Problema que aborda** | Una clase cambia por decisiones de negocio, presentación, almacenamiento o reporte a la vez. |
| **Escenario de aplicación** | Separación del cálculo de una factura respecto de su impresión o exportación. |
| **Ventaja principal** | Los módulos quedan enfocados y sus pruebas requieren menos contexto. |
| **Desventaja o precaución** | Separar cada operación en una clase distinta fragmenta el modelo sin mejorar su cohesión. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo3/solid/responsabilidad_unica/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
