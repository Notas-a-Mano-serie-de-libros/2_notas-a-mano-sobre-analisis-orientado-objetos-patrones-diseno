<h1 style="text-align:center;"><strong> KISS (Keep It Simple, Stupid)</strong></h1>
...
-  <b>Evita la sobreabstracción:</b> No introduzcas patrones, interfaces o capas adicionales si no aportan un beneficio tangible.
...
##  Malas prácticas contrarias a KISS
...
<li><a href="#ejemplo-kiss-1"><strong>Calculadora innecesariamente compleja frente a solución simple</strong></a><small>Ambas versiones resuelven las mismas operaciones; la segunda reduce ramas y posibilidades de error.</small></li>
</ul>

## Ejemplos desarrollados

<a id="ejemplo-kiss-1"></a>
### 1. Calculadora innecesariamente compleja frente a solución simple
...
??? example "CalculadoraCompleja.java"

    ```java
    package capitulo4.kiss;
...
??? example "CalculadoraSimple.java"
...
| --- | --- |
| **Problema que aborda** | La solución contiene más mecanismos y estados de los necesarios para su propósito. |
| **Escenario de aplicación** | Flujos directos que no requieren un framework, jerarquía o configuración generalizada. |
| **Ventaja principal** | Reduce carga cognitiva, errores y costo de mantenimiento. |
| **Desventaja o precaución** | Simplificar no debe eliminar requisitos, validaciones o claridad del dominio. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo4/kiss/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
