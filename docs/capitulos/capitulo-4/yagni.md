...
<strong> YAGNI (You Aren’t Gonna Need It)</strong>
</h1>
...
-  <b>Evita la “abstracción temprana”:</b> No generalices hasta tener evidencia de repetición o variación real.
...
##  Malas prácticas contrarias a YAGNI
...
<li><a href="yagni-ejemplo/"><strong>Sistema de gestión de notas</strong></a><small>El caso muestra cómo evitar funcionalidades anticipadas que no fueron solicitadas.</small></li>
</ul>

## Ejemplos y diagramas UML

### 1. Sistema de gestión de notas (Principio YAGNI)

Se solicita implementar un módulo que permita realizar operaciones básicas sobre las notas: crear , editar y eliminar . Sin embargo, durante el desarrollo, el programador decidió anticiparse a posibles requerimientos futuros, añadiendo funcionalidades que no fueron solicitadas como exportar las notas a PDF o imagen, y enviar notificaciones por correo.

<figure class="uml-figure uml-figure--wide">
  <img src="../../../assets/images/contenido/capitulos/capitulo4/yagni/yagni_ejemplo_mal.png" alt="Diagrama UML de Sistema de gestión de notas (Principio YAGNI)">
  <figcaption><strong>Modelo UML.</strong> Sistema de gestión de notas (Principio YAGNI), vista 1.</figcaption>
</figure>

<figure class="uml-figure uml-figure--wide">
  <img src="../../../assets/images/contenido/capitulos/capitulo4/yagni/yagni_ejemplo_bien.png" alt="Diagrama UML de Sistema de gestión de notas (Principio YAGNI)">
  <figcaption><strong>Modelo UML.</strong> Sistema de gestión de notas (Principio YAGNI), vista 2.</figcaption>
</figure>

[Estudiar el caso y desplegar su código Java](yagni-ejemplo.md){ .md-button }
...
| --- | --- |
| **Problema que aborda** | Se construyen capacidades para necesidades futuras que todavía no han sido confirmadas. |
| **Escenario de aplicación** | Exportadores, integraciones o canales añadidos sin un caso de uso vigente. |
| **Ventaja principal** | Reduce código, pruebas, supuestos y mantenimiento innecesarios. |
| **Desventaja o precaución** | No justifica ignorar requisitos de seguridad, calidad o evolución ya conocidos. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo4/yagni/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
