...
<div align="center">
  <figure>
    <img src="../../../assets/images/contenido/capitulos/capitulo4/demeter/ley_demeter_generico.png" alt="Ley de Demeter - estructura genérica" style="max-width:80%;">
...
<li><a href="demeter-ejemplo-libreria/"><strong>Sistema de Librería</strong></a><small>El ejemplo analiza el acceso encadenado a objetos y la reducción del conocimiento entre clases.</small></li>
</ul>

## Ejemplos y diagramas UML

### 1. Sistema de Librería

Se solicita diseñar un sistema que permita consultar los ejemplares disponibles en una librería . El sistema debe mostrar al usuario la información esencial de cada libro —título, número de páginas, género literario e información del autor—, además de permitir la consulta directa del autor asociado a un libro específico .

<figure class="uml-figure uml-figure--wide">
  <img src="../../../assets/images/contenido/capitulos/capitulo4/demeter/ley_demeter_ejemplo_mal.png" alt="Diagrama UML de Sistema de Librería">
  <figcaption><strong>Modelo UML.</strong> Sistema de Librería, vista 1.</figcaption>
</figure>

<figure class="uml-figure uml-figure--wide">
  <img src="../../../assets/images/contenido/capitulos/capitulo4/demeter/ley_demeter_ejemplo_bien.png" alt="Diagrama UML de Sistema de Librería">
  <figcaption><strong>Modelo UML.</strong> Sistema de Librería, vista 2.</figcaption>
</figure>

[Estudiar el caso y desplegar su código Java](demeter-ejemplo-libreria.md){ .md-button }
...
| --- | --- |
| **Problema que aborda** | Un objeto navega por cadenas de colaboradores y conoce su estructura interna. |
| **Escenario de aplicación** | Modelos con agregados, capas o árboles de objetos. |
| **Ventaja principal** | Los cambios internos quedan encapsulados tras operaciones significativas. |
| **Desventaja o precaución** | Delegar mecánicamente cada acceso puede inflar interfaces sin reducir conocimiento real. |
...
[:material-code-tags: Consultar el README y el código fuente](https://github.com/Notas-a-Mano-serie-de-libros/2_notas-a-mano-sobre-analisis-orientado-objetos-patrones-diseno/blob/main/src/main/java/capitulo4/demeter/README.md){ .md-button target="_blank" rel="noopener noreferrer" }
