package capitulo7.visitor.abstraccion.implementacion;

import capitulo7.visitor.abstraccion.IVisitable;
import capitulo7.visitor.abstraccion.Tarjeta;
import capitulo7.visitor.visitante.IVisitante;

public class TarjetaBlack extends Tarjeta implements IVisitable {

    public void operacionLegada1() {
        System.out.println("\tSoy la primera operacion para TarjetaBlack");
    }

    @Override
    public void operacionLegada2() {
        System.out.println("\tSoy la segunda operacion para TarjetaBlack");
    }

    @Override
    public void operacionLegada3() {
        System.out.println("\tSoy la tercera operacion para TarjetaBlack");
    }

    @Override
    public void operacionLegada4() {
        System.out.println("\tSoy la cuarta operacion para TarjetaBlack");
    }

    @Override
    public void operacionLegadaN() {
        System.out.println("\tSoy una operacion de otras tantas  para TarjetaBlack");
    }
